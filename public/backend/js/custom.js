    ...
    jQuery(document).on('ready', function () {
        ...
        $(window).on('scroll',function() {
            ...
            if ($(this).scrollTop() > 30){ 
                ...
                $('.DamyNavbar').removeClass("top-navbar navbar");
        ...
        $(function() {
            ...
            $('.accordion').find('.accordion-title-child').on('click', function(){
                // Adds Active Class
                $(this).toggleClass('active');
                // Expand or Collapse This Panel
                $(this).next().slideToggle('fast');
                // Hide The Other Panels
                $('.accordion-content-child').not($(this).next()).slideUp('fast');
                // Removes Active Class From Other Titles
                $('.accordion-title-child').not($(this)).removeClass('active');
            });
        });
