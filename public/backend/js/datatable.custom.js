$(document).ready(function () {
    ...
    $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
        ...
        if (Search_Criteria.trim() === '1') {
            var Order_ID = data[2].toLowerCase(); 
            return !!Order_ID.includes(Search_Value);
        } else if (Search_Criteria.trim() === '2' || Search_Criteria.trim() === '3') {
            var Pickup = data[0].toLowerCase();
            console.log(data.map((item , ind)=> item[0]  ));  
            // .split('Delivery')[0]
            return !!Pickup.includes(Search_Value); 
        } else if (Search_Criteria.trim() === '4' || Search_Criteria.trim() === '5') {
            var Delivery = data[0].toLowerCase();
            return !!Delivery.includes(Search_Value);
        } else if (Search_Criteria.trim() === '6') {
            var Company = data[3].toLowerCase();
            return !!Company.includes(Search_Value);
        } else if (Search_Criteria.trim() === '7') {
            var vehicles = data[1].toLowerCase();
            return !!vehicles.includes(Search_Value);
        } else {
            return false; 
        }
    });
...
$(document).ready(function() {
    ...
    // Move records per page dropdown to the right side
