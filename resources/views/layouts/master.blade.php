...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Day Dispatch | Transportation Company</title>
        <meta name="description" content="Day Dispatch is your trusted partner for efficient dispatching services. Instantly estimate and schedule dispatching for anything, anywhere. Explore our reliable vehicle transportation services today.">
