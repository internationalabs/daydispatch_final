...
<link rel="stylesheet" href="https://daydispatch.com/frontend/css/meanmenu.css">
<!-- jQuery -->
...
<section class="page-title-area breadcrumb-spacing"
         data-background="{{ asset('frontend/img/broker-banner.webp') }}">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xxl-9">
                <div class="page-title-wrapper text-center">
                    <h3 class="page-title mb-25">Brokers</h3>
                    <div class="breadcrumb-menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                            <ul class="trail-items">
                                <li class="trail-item trail-begin"><a
                                        href="{{ route('Frontend.index') }}"><span>Home</span></a></li>
                                <li class="trail-item trail-end"><span>Brokers</span></li>
                            </ul>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".5s">
            <div class="col-xl-6 col-md-6">
                <div class="services__3-item mb-30">
                    ...
                    <p class="services__3-item-text">First of all, you just have to post the vehicle on Day Dispatch.
            ...
            <div class="col-xl-6 col-md-6">
                <div class="services__3-item mb-30">
                    ...
                    <p class="services__3-item-text"> Found the perfect match? Good to go! You can accept
                         the request of the carrier and proceed to shipment of your vehicle with them. 
                         Call them and book now! Shipment of the vehicle 
            ...
            <div class="col-xl-6 col-md-6">
                <div class="services__3-item mb-30">
                    ...
                    <p class="services__3-item-text">Was not it easy? Yes, the wait is over your Shipment is ready to ship to
...
<div class="container table1">  
    <div class="section__title mb-50 mt-50">
        ...
        <h2 class="title text-center">PAYMENT PLAN for Brokers</h2> 
    </div>
    <table id="table-1" class="table border wow fadeInUp"  data-wow-duration="1.5s" data-wow-delay=".3s">
        <thead>
            <tr>
                ...
                <div class="about__content-2 mb-60 wow fadeInRight" data-wow-duration="1.5s" data-wow-delay=".5s">
                    ...
                    <div class="about__content-tab-2 mt-40">
                        <ul class="nav mb-5 " id="myTab" role="tablist">
                            ...
                            <!--    <p class="text-center">With us, you will have the freedom to ship a single vehicle. Yes! No need to be a-->
