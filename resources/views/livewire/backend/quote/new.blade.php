                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="email"
                                                                        ...
                                                                        value="{{ old('Customer_Email') }}" autocomplete="off" required>
                                                                    <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-3 cod-inputs">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="custom-select COD_Payment_Mode"
                                                                ...
                                                                <option value="Cash / Certified Funds">Cash /
                                                                    Certified
                                                                    Funds
                                                                </option>
                                                            </select>
                                            ...
                                            <div class="row p-3">
                                                <div class="col-lg-12 shadow-sm p-3 border">
                                                    ...
                                                    <div class="vehcile-information">
                                                        ...
                                                        <div class="vehcile-information-container-ymm">
                                                            <div class="row p-3">
                                                                <div class="col-lg-6 basic-vehcile-info">
                                                                    <div class="form-group">
                                                                        <label>Customer Name</label>
                                                                        <input type="text"
                                                                            class="form-control " placeholder="Enter Customer Name"
                                                    ...
                                                    <div class="row p-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Orig_ZipCode_Heavy" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row p-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Dest_ZipCode_Heavy_d" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 cod-inputs">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select COD_Payment_Mode"
                                                                    ...
                                                                    <option value="">Select AnyOne</option>
                                                                    <option value="Check">Check</option>
                                                                    <option value="Cash / Certified Funds">Cash / Certified
                                                                        Funds
                                                                    </option>
                                                                </select>
                                                                <div class="invalid-feedback">Select AnyOne</div>
                                ...
                                <div class="card user-settings-box mb-30">
                                    <div class="card-body">
                                        ...
                                        <form class="was-validated" method="POST"
                                            ...
                                            <div class="row p-3">
                                                <div class="col-lg-6 shadow-sm p-3">
                                                    <h5  class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b>ORIGIN LOCATION</b></h5>
                                                ...
                                                <div class="col-lg-6 shadow-sm p-3">
                                                    <h5  class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b>DESTINATION LOCATION</b></h5>
                                            ...
                                            <div class="row p-3">
                                                <div class="col-lg-6 shadow-sm ">
                                                    {{-- <h5  class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b>ORIGIN ADDRESS</b></h5> --}}
                                                    ...
                                                    <div class="row p-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Orig_ZipCode_Dry" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6 shadow-sm p-3">
                                                    {{-- <h5  class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b>DESTINATION ADDRESS</b></h5> --}}
                                                    ...
                                                    <div class="row ">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Dest_ZipCode_Dry_d" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row p-3">
                                                <div class="col-lg-12 shadow-sm p-3">
                                                    <h5 class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b> Post Freight Load </b></h5>
                                            ...
                                            <div class="row DateParent">
                                                <div class="col-lg-12 shadow-sm p-3 border">
                                                    <h5 class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b>VEHICLE PICKUP INFORMATION</b></h5>
                                                    <div class="row p-3">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label>Pickup Date</label>
                                            ...
                                            <div class="row p-3">
                                                <div class="col-lg-12 shadow-sm p-3">
                                                    <h5 class="text-white py-2 d-flex justify-content-center" style="background: #113771;"><b>Carrier / Payment</b></h5>
    ...
    $(document).ready(function() {
        ...
        $('#heavy .Dest_ZipCode_Heavy.typeahead').typeahead({
            ...
            updater: function(item) {
                ...
                $('.Dest_ZipCode_Heavy_d').val(zipCode);
                return item;
            }
        });
        ...
        $('#heavy .Origin_ZipCode_Heavy.typeahead').typeahead({
            ...
            updater: function(item) {
                ...
                $('.Orig_ZipCode_Heavy').val(zipCode);
        ...
        $('#dry .Dest_ZipCode_Dry.typeahead').typeahead({
            ...
            updater: function(item) {
                ...
                $('.Dest_ZipCode_Dry_d').val(zipCode);
                return item;
            }
        });
