                        ...
                        <tr class="card-row" data-status="active">
                            ...
                            <td>
                                ...
                                @if ($List->user_id === $currentUser->id)
                                    ...
                                    <a class="btn btn-outline-primary mb-2 w-100 d-block text-nowrap"
                                        href="{{ route('User.Quote.Restore', ['List_ID' => $List->id]) }}"> Restore
                                        Quote</a>
                                @endif
                                {{-- </div>
                                </div> --}}
                ...
                <div id="button-section" class="mb-3">
                    <ul class="nav justify-content-center custom-nav" role="tablist">
                        <li class="nav-item mr-2" role="presentation">
                             <a class="nav-link w-100 custom-tab active-tab" id="history-tab" data-toggle="tab" href="#history" role="tab"
                              aria-controls="history" onclick="showForm()" aria-selected="true">
                                HISTORY/STATUS
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link w-100  custom-tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false"
                             data-id="{{ $List->id ?? '' }}" onclick="setListId(this)">VIEW/HISTORY</a>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    //         html += '<table class="status-table table wrap-text">';  // Add Bootstrap's table class for better styling
    //         html += '<thead>';
    //         html += '<tr>';
    ...
    //             html += '<tr>';
    //             html += '<td class="combined-text">' + item.history_status + ' - ' + item.expected_date + '</td>';
