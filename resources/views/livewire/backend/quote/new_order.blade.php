...
<div class="card">
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <table
                class="display carrier dataTable text-center table-1 table-bordered table-cards">
                        ...
                        <tr class="card-row" data-status="active">
                            ...
                            {{-- <td>
                                ...
                                <span class="text-nowrap">
                                    ...
                                    <a href="tel:{{ $List->authorized_user->Contact_Phone }}">
                                        {{ $List->authorized_user->Contact_Phone }}
                                    </a>
                                </span><br>
                                <span class="text-nowrap">
                                    <strong>Email:</strong>
                                    <a href="mailto:{{ $List->authorized_user->email }}">
                            ...
                            <td>
                                ...
                                @if ($List->user_id === $currentUser->id)
                                    ...
                                    data-list-id="{{ $List->id }}" data-user-id="{{ $List->user_id }}">Mail
                                    Order Form</a>
                                    @endif
                    ...
                    <ul class="nav justify-content-center custom-nav" role="tablist">
                        <li class="nav-item mr-2" role="presentation">
                            <a class="nav-link w-100 custom-tab" href="#tab1" role="tab" aria-controls="tab1"
                                aria-selected="true" onclick="showForm()">HISTORY/STATUS</a>
                        </li>
