...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Logistic Carriers History</h5>
    </div>
    <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="AdminTab" role="tabpanel">
                            <form method="POST" action="{{ route('Admin.logisticCarriers.Comment') }}" id="commentForm"
...
<script>
    $(".btn-click").click(function() {
        ...
        $.ajax({
                url: `{{ route('Admin.logisticCarriers.Comment.Get') }}`,
                type: 'GET',
                data: {
                    'HistoryID': HistoryID
                },
