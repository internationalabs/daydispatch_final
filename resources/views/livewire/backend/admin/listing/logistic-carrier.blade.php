...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Logistic Carriers</h5>
    </div>
    <div class="card-body">
        <div class="table-responsive dataTables_wrapper me-0 d-flex">
                ...
                <table>
                    <tbody class="dataTables_filter">
                        <tr>
                            ...
                            <form action="{{ route('Admin.Logistic.Carrier') }}">
                                <td>
            ...
            <div class="col-lg-2 col-md-6 col-sm-12">
                <a class="btn btn-success add-btn btn-block btn-sm" data-bs-toggle="modal" href="#AdNewCarriers"><i
                        class="ri-add-line align-bottom me-1"></i> Add New Logistic Carriers
                </a>
            </div>
        </div>
        <table id="newexample" class="table table-bordered dt-responsive nowrap table-striped align-middle text-center"
            style="width:100%">
            <thead>
                <tr>
                    <th>Company Name</th>
            ...
            <div class="card mt-4">
                <div class="card-body p-4">
                    <div class="text-center mt-2">
                        <h5 class="text-primary">Add New Logistic Carrier</h5>
                        <!--<p class="text-muted">Get your free Day Dispatch account now</p>-->
                    </div>
                    <div class="p-2 mt-4">
                        <form action="{{ route('Admin.LogCarrier.Store') }}" method="POST" class="needs-validation"
                            novalidate>
                            @csrf
...
<script>
    $(".get-history").click(function() {
        ...
        $.ajax({
            url: '{{ route('Admin.History.Logistic.Carrier') }}',
            type: 'GET',
            data: {
                'CompanyID': CompanyID
            },
