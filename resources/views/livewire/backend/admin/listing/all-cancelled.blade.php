        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('Admin.Cancelled') }}">All Cancelled</a></li>
                </ol>
            </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Cancelled</h5>
    </div>
    <div class="card-body">
        <table id="scroll-horizontal" class="table nowrap align-middle text-center"
            ...
            @foreach ($Lisiting as $List)
                <tr>
                    ...
                    <td>
                        <h6>Status: <span class="badge badge-warning">{{ $List->all_listing->Listing_Status }}</span>
                        </h6>
