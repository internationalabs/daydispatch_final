        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('Admin.Requested') }}">Requested</a></li>
                </ol>
            </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Requested</h5>
    </div>
    <div class="card-body">
        <table id="scroll-horizontal" class="table nowrap align-middle text-center"
            ...
            @foreach ($Lisiting as $List)
                <tr>
                    ...
                    <td>
                        <h6>Status: <span class="badge bg-warning">{{ $List->status }}</span></h6>
                    </td>
                </tr>
            @endforeach
            </tbody>
