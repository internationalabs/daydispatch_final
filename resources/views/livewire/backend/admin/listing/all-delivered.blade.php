        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('Admin.Delivered') }}">All Delivered</a></li>
                </ol>
            </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Delivered</h5>
    </div>
    <div class="card-body">
            ...
            @foreach ($Lisiting as $List)
                <tr>
                    ...
                    <td>
                        ...
                        {{ \Carbon\Carbon::parse($List->all_listing->created_at)->format('d M, Y') }}<br>
                        <strong>Modified At:</strong><br>
                        {{ \Carbon\Carbon::parse($List->all_listing->updated_at)->format('d M, Y') }}
                    </td>
                    <td>
                        <h6>Status: <span
