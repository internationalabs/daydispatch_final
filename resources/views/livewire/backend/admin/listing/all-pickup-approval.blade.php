        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('Admin.PickUp.Approval') }}">Pickup Approvals</a></li>
                </ol>
            </div>
...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All PickUp Approvals</h5>
    </div>
    <div class="card-body">
        <table id="scroll-horizontal" class="table nowrap align-middle text-center"
            ...
            @foreach ($Lisiting as $List)
                <tr>
                            ...
                            <a href="javascript:void(0)" tabindex="0" class="" data-toggle="popover"
                               ...
                               title="Attached vehicles" data-content=
                                ...
                                @if ($vehcile->is_hazmat_Check !== 0)
                                    Hazmat Required<br>
                                @endif
                            @endforeach" data-html="true">vehicles ({{ count($List->all_listing->dry_vans) }})
                            </a>
                        @endif
                        <br>
                        <a href="javascript:void(0)" tabindex="0" class="" data-toggle="popover"
                    ...
                    <td>
                        <h6>Status: <span
                                class="badge bg-warning">{{ $List->all_listing->Listing_Status }}</span>
                        </h6>
