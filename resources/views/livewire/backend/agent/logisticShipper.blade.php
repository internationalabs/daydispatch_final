...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Logistic Shippers</h5>
    </div>
    <div class="card-body">
        <table id="" class="table table-striped align-middle text-center"
            ...
            @foreach ($carrier as $List)
                <tr>
                    ...
                    <td>{{ $List->address }}</td>
                    <td>
                        <button class="btn btn-primary call-count"
                                onclick="document.location.href = 'tel:{{ $List->main_number }}'">
                    ...
                    <td>
                        <button class="btn btn-primary call-count"
                                onclick="document.location.href = 'tel:{{ $List->local_number }}'">
                            <input type="hidden" name="company_id" class="company_id" value="{{ $List->id }}">
                    ...
                    <td>
                        <div class="dropdown d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item add-history" data-bs-toggle="modal"
                                       data-bs-target="#addHistory"><i
...
<div class="modal fade" id="addHistory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <form id="addHistoryForm" action="{{ route('Agent.logisticShippers.History.Store') }}" method="POST"
                            ...
                            <div class=" tab-menu-heading p-0 bg-light">
                                <div class="tabs-menu1 ">
                                    ...
                                    <ul class="nav panel-tabs  gap-2">
                                        ...
                                        <li><a href="#tab2" data-toggle="tab" class="btn btn-success">VIEW HISTORY</a>
                                        </li>
                                        <li></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="custom-control custom-radio mb-3">
                                        ...
                                        <label class="custom-control-label form-label" for="notConnected">Not
                                            Connected</label>
                                    </div>
                                </div>
...
<script>
    ...
    $(".add-history").click(function () {
        ...
        $.ajax({
            url: '{{ route('Agent.logisticShippers.Retrieve.History') }}',
            type: 'GET',
            data: {
                'HistoryID': HistoryID
            },
    ...
    $(".call-count").click(function () {
        ...
        $.ajax({
            url: '{{ route('Agent.logisticShippers.Call.Count') }}',
            type: 'GET',
            data: {
                'company': company
            },
