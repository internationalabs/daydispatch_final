...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Logistic Brokers List</h5>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="addHistory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <form id="addHistoryFormLogisticBroker" action="{{ route('Agent.logisticBrokers.History.Store') }}" method="POST" class="needs-validation" novalidate class="tablelist-form" autocomplete="off">
                @csrf
...
<script>
    ...
    $(".call-count").click(function () {
        ...
        $.ajax({
            url: '{{ route('Agent.logisticBrokers.Call.Count') }}',
            type: 'GET',
            data: {
                'company': company
            },
...
// ======================modal js==============================
    ...
    $(".add-history").click(function () {
        ...
        $.ajax({
            url: '{{ route('Agent.logisticBrokers.Retrieve.History') }}',
            type: 'GET',
            data: {
                'HistoryID': HistoryID
            },
        ...
        // Form submission for the second modal
        $("#addHistoryFormLogisticBroker").submit(function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#addHistoryFormLogisticBroker')[0].reset();
