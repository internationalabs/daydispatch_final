...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">All Users List</h5>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="addHistory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            ...
            <form id="historyFormLogisticCarrier" action="{{ route('Agent.logisticCarriers.History.Store') }}" method="POST" class="needs-validation" novalidate class="tablelist-form" autocomplete="off">
                @csrf
...
// ======================modal js==============================
    ...
    $(".add-history").click(function () {
        ...
        $.ajax({
            url: '{{ route('Agent.logisticCarriers.Retrieve.History') }}',
            type: 'GET',
            data: {
                'HistoryID': HistoryID
            },
    ...
    $("#historyFormLogisticCarrier").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#historyFormLogisticCarrier')[0].reset();
                // Showing the history data
                html = "";
                $.each(data, function(index, val) {
                    // Assuming val['created_at'] is a string representation of the date
                    var createdAt = new Date(val['created_at']);
    ...
    $(".call-count").click(function () {
        ...
        $.ajax({
            url: '{{ route('Agent.logisticCarriers.Call.Count') }}',
            type: 'GET',
            data: {
                'company': company
            },
