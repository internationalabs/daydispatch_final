                        ...
                        <tr>
                            <td>
                                <strong><a target="_blank"
                                           href="{{ route('View.Profile', $List->all_listing->request_broker->requested_user->id) }}">{{ $List->all_listing->request_broker->requested_user->Company_Name }}</a></strong><br>
                                <strong>Request Post:
                            ...
                            <td>
                                <strong>Price to Pay:
                                </strong>${{ $List->all_listing->paymentinfo->COD_Amount }}<br>
                                {{-- <strong>Assigned to:
                                </strong>{{ $List->all_listing->request_broker->requested_user->usr_type }}<br> --}}
                                <strong><a
