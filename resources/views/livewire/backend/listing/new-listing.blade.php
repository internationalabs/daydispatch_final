...
<style>
    ...
    .btn-close.remove-phone-number {
        color: red !important; /* Override Bootstrap's default color */
    }
        /* Add fade-in and scale-up animation */
...
<section class="profile-area">
    <div class="profile-header mb-10">
        <div class="container-fluid">
            <div class="user-profile-nav shadow-sm border rounded" style="padding: 25px 25px 25px 25px;">
                                ...
                                <div class="card user-settings-box mb-30">
                                    <div class="card-body">
                                        ...
                                        <form class="was-validated" method="POST"
                                            action="{{ route('User.New.Listing.Submit') }}"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <h3><i class='bx bx-file'></i> New Listing For Vehicle</h3>
                                            <h5 style=""><b>Refrence ID:</b> #{{ $L_PID }} <i
                                                    class="fa-solid fa-circle-question" onclick="question()"></i>
                                            </h5>
                                            <div class="showalternativecode">This unique DD order id belongs to day
                                                dispatch, Create your custom order ID in the field below for a
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-lg-4">
                                                    <div class="form-group form-check">
                                                        ...
                                                        <label class="form-check-label" for="custom_Check">Schedule
                                                            Listing</label>
                                                    </div>
                                                    <div class="form-group form-check">
                                                        <input type="checkbox" class="form-check-input"
                                                            name="Private_Listing" value="1" id="private_Check">
                                                        <label class="form-check-label" for="private_Check">Draft
                                                            Listing</label>
                                                    </div>
                                            ...
                                            <div class="row justify-content-center w-50 m-auto p-3">
                                                <div
                                                    class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-4 shadow-sm border rounded p-3">
                                ...
                                <div class="card user-settings-box mb-30">
                                    <div class="card-body">
                                        ...
                                        <form class="was-validated" method="POST"
                                            ...
                                            enctype="multipart/form-data">
                                            @csrf
                                            <h3><i class='bx bx-file'></i> New Listing For Heavy Equipment</h3>
                                            <h5 style=""><b>Refrence ID:</b> #{{ $L_PID }} <i
                                                    class="fa-solid fa-circle-question" onclick="question()"></i>
                                            </h5>
                                            <div class="showalternativecode">This unique DD order id belongs to day
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="d-flex">
                                                                    <!-- Initial Phone Number Input (Local_Phone) -->
                                                                    <input id="local-phone-input-heavy" class="form-control phone-number" type="text" placeholder="Phone Number" name="Local_Phone[]" value="{{ old('Local_Phone') }}">
                                                                    <button type="button" class="btn btn-success ms-2" id="add-local-phone-number-heavy">
                                                                        <i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                                <div class="invalid-feedback" id="invalid-phone-message-heavy">
                                                                    Enter Phone.
                                                                </div>
                                                                <!-- Toast container for added phone numbers -->
                                                                <div id="local-phone-numbers-toast-container-heavy" class="mt-3"></div>
                                                            </div>
                                                        </div>
                                                        <div class="toast" style="display: none;">
                                                            <div class="toast-body d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="Origin_Address_II"
                                                                    placeholder="Enter Origin 2" value=""
                                                                    autocomplete="off">
                                                                <div class="invalid-feedback">
                                                                    Enter Origin 2.
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label>Pickup Location *</label>
                                                                <input type="text"
                                                                    class="form-control Origin_ZipCode_Heavy typeahead"
                                                                    name="Origin_ZipCode" placeholder="Enter ZipCode"
                                                                    value="{{ old('Origin_ZipCode') }}" required>
                                                                <div class="invalid-feedback">
                                                                    Enter Pickup Location.
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>State</label>
                                                                <input type="text" class="form-control Orig_State_Heavy"
                                                                    name="Origin_State" placeholder="State">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>City</label>
                                                                <input type="text" class="form-control Orig_City_Heavy"
                                                                    name="Origin_City" placeholder="City">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Orig_ZipCode2_Heavy" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="d-flex">
                                                                    <!-- Initial Phone Number Input (Local_Phone) -->
                                                                    <input id="local-phone-input-heavy-d" class="form-control phone-number" type="text" placeholder="Phone Number" name="Local_Phone[]" value="{{ old('Local_Phone') }}">
                                                                    <button type="button" class="btn btn-success ms-2" id="add-local-phone-number-heavy-d">
                                                                        <i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                                <div class="invalid-feedback" id="invalid-phone-message-heavy-d">
                                                                    Enter Phone.
                                                                </div>
                                                                <!-- Toast container for added phone numbers -->
                                                                <div id="local-phone-numbers-toast-container-heavy-d" class="mt-3"></div>
                                                            </div>
                                                        </div>
                                                        <div class="toast" style="display: none;">
                                                            <div class="toast-body d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label>Delivery Location *</label>
                                                                <input type="text"
                                                                    class="form-control Dest_ZipCode_Heavy typeahead"
                                                                    name="Dest_ZipCode" placeholder="Enter ZipCode"
                                                                    value="{{ old('Dest_ZipCode') }}" required>
                                                                <div class="invalid-feedback">
                                                                    Enter Delivery Location.
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>State</label>
                                                                <input type="text" class="form-control Dest_State_Heavy_d"
                                                                    name="Dest_State" placeholder="State">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>City</label>
                                                                <input type="text" class="form-control Dest_City_Heavy_d"
                                                                    name="Dest_City" placeholder="City">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Dest_ZipCode2_Heavy_d" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="custom-select"
                                                                        ...
                                                                        <option selected="" value="Running">
                                                                            Running
                                                                        </option>
                                                                        <option value="Not Running">Not Running
                                                                        </option>
                                                                    </select>
                                                                    <div class="invalid-feedback">Select Equipment
                                                                        Condition
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <div class="form-group multiSelect">
                                                                    ...
                                                                    <div class="invalid-feedback">Select Any Equipment
                                                                        Type
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3">
                                                                <div class="form-group multiSelect">
                                                                    ...
                                                                    <select class="custom-select custom-multi-select"
                                                                        ...
                                                                        multiple name="Trailer_Specification[]"
                                                                        required>
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group multiSelect">
                                                                    ...
                                                                    <select class="custom-select custom-multi-select"
                                                                        ...
                                                                        multiple name="Shipment_Preferences[]"
                                                                        required>
                                                                        {{-- <option selected="" value="">Select
                                                                            Shipment
                                                                            Preferences
                                                                        </option> --}}
                                                                        <option value="LTL">LTL (Less Than Truck
                                                                            Load)
                                                                        </option>
                                                                        <option value="FTL">FTL (Full Truck Load)
                                                                        </option>
                                                                    </select>
                                                                    <div class="invalid-feedback">Select Shipment
                                                                        Preferences
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 shadow-sm p-3">
                                                    ...
                                                    <h4 class="text-white py-2 d-flex justify-content-center"
                                                        style="background: #113771;">
                                                        <i class="bi bi-hash mr-2"></i> PICKUP INFORMATION
                                                    </h4>
                                                    <div class="row DateParent">
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row justify-content-center w-50 m-auto p-3">
                                                        <div class="col-sm-4">
                                                            <button type="button"
                                                                class="btn btn-danger compare-listing"
                                                                data-toggle="modal" data-target="#CompareListing">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 shadow-sm p-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input"
                                                                        name="Vehcile_Images[]"
                                                                        id="image-upload-second" accept="image/*"
                                                                        multiple>
                                                                    <label class="custom-file-label">Choose
                                                                        file</label>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div id="image-preview-second" class="displayimages row">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="contractDropdown">Select Contract:</label>
                                                                <select class="form-control showmycontract12"
                                                                    onchange="updateTextareaAndLabelEquipment()">
                                                                    @foreach ($MyContract as $key => $row)
                                                                        <option value="{{ $row->My_Contract }}"
                                                                            data-contract-name="{{ $row->contractName }}">
                                                                            Contract:{{ $key + 1 }} -
                                                            ...
                                                            <div class="form-group">
                                                                <label class="textareaLabel">Contract</label>
                                                                <textarea class="showcontent12 form-control" cols="30" rows="15" name="Listing_Contract">
                                                            @if (count($MyContract) > 0)
                                                            {{ $MyContract[0]->My_Contract }}
                                                            @endif
                                                        </textarea>
                                ...
                                <div class="card user-settings-box mb-30">
                                    <div class="card-body">
                                        ...
                                        <form class="was-validated" method="POST"
                                            ...
                                            enctype="multipart/form-data">
                                            @csrf
                                            <h3><i class='bx bx-file'></i> New Listing For Freight Shipping</h3>
                                            <h5 style=""><b>Refrence ID:</b> #{{ $L_PID }} <i
                                                    class="fa-solid fa-circle-question" onclick="question()"></i>
                                            </h5>
                                            <div class="showalternativecode">This unique DD order id belongs to day
                                                dispatch,
                                                Create your custom order ID in the field below for a personalized
                                                experience.
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="d-flex">
                                                                    <!-- Initial Phone Number Input (Local_Phone) -->
                                                                    <input id="local-phone-input-freight" class="form-control phone-number" type="text" placeholder="Phone Number" name="Local_Phone[]" value="{{ old('Local_Phone') }}">
                                                                    <button type="button" class="btn btn-success ms-2" id="add-local-phone-number-freight">
                                                                        <i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                                <div class="invalid-feedback" id="invalid-phone-message-freight">
                                                                    Enter Phone.
                                                                </div>
                                                                <!-- Toast container for added phone numbers -->
                                                                <div id="local-phone-numbers-toast-container-freight" class="mt-3"></div>
                                                            </div>
                                                        </div>
                                                        <div class="toast" style="display: none;">
                                                            <div class="toast-body d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label>Pickup Location *</label>
                                                                <input type="text"
                                                                    class="form-control Origin_ZipCode_Dry typeahead"
                                                                    name="Origin_ZipCode" placeholder="Enter ZipCode"
                                                                    value="{{ old('Origin_ZipCode') }}" required>
                                                                <div class="invalid-feedback">
                                                                    Enter Pickup Location.
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>State</label>
                                                                <input type="text" class="form-control Orig_State_Dry"
                                                                    name="Origin_State" placeholder="State">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>City</label>
                                                                <input type="text" class="form-control Orig_City_Dry"
                                                                    name="Origin_City" placeholder="City">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Orig_ZipCode2_Dry" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 ">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="d-flex">
                                                                    <!-- Initial Phone Number Input (Local_Phone) -->
                                                                    <input id="local-phone-input-freight-d" class="form-control phone-number" type="text" placeholder="Phone Number" name="Local_Phone[]" value="{{ old('Local_Phone') }}">
                                                                    <button type="button" class="btn btn-success ms-2" id="add-local-phone-number-freight-d">
                                                                        <i class="fas fa-plus"></i>
                                                                    </button>
                                                                </div>
                                                                <div class="invalid-feedback" id="invalid-phone-message-freight-d">
                                                                    Enter Phone.
                                                                </div>
                                                                <!-- Toast container for added phone numbers -->
                                                                <div id="local-phone-numbers-toast-container-freight-d" class="mt-3"></div>
                                                            </div>
                                                        </div>
                                                        <div class="toast" style="display: none;">
                                                            <div class="toast-body d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group">
                                                                <label>Delivery Location *</label>
                                                                <input type="text"
                                                                    class="form-control Dest_ZipCode_Dry typeahead"
                                                                    name="Dest_ZipCode" placeholder="Enter ZipCode"
                                                                    value="{{ old('Dest_ZipCode') }}" required>
                                                                <div class="invalid-feedback">
                                                                    Enter Delivery Location.
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>State</label>
                                                                <input type="text" class="form-control Dest_State_Dry_d"
                                                                    name="Dest_State" placeholder="State">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>City</label>
                                                                <input type="text" class="form-control Dest_City_Dry_d"
                                                                    name="Dest_City" placeholder="City">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                <label>Zip Code</label>
                                                                <input type="text"
                                                                    class="form-control Dest_ZipCode2_Dry_d" readonly
                                                                    name="" placeholder="zipcode">
                                                                <div class="invalid-feedback">Entered ZipCode.</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="invalid-feedback">Select Any Class
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <div class="form-group multiSelect">
                                                                    <label>Equipment Type</label>
                                                                    <select class="custom-select custom-multi-select"
                                                                        multiple data-placeholder="Select Trailer"
                                                                        name="Trailer_Type_Dry[]" required>
                                                                        <option value="VAN">VAN</option>
                                                                        <option value="REEFER">REEFER</option>
                                                                        <option value="FLATBED">FLATBED</option>
                                                                        <option value="STEP OR DROP DECK">STEP OR DROP
                                                                            DECK
                                                                        </option>
                                                                        ...
                                                                        <option value="CONTAINER / DRAYAGE">CONTAINER
                                                                            ...
                                                                            DRAYAGE</option>
                                                                        <option
                                                                            value="STRAIGHT TRUCK / BOX TRUCK /SPRINTER">
                                                                            STRAIGHT TRUCK / BOX TRUCK /SPRINTER
                                                                        </option>
                                                                        ...
                                                                        <option value="20ft container">20ft container
                                                                        </option>
                                                                        <option value="48ft container">48ft container
                                                                        </option>
                                                                        <option value="53ft container">53ft container
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3">
                                                                ...
                                                                <div class="d-flex" style="margin-top: -23px;">
                                                                    <input style="margin-top: 20px;" type="text"
                                                                        class="form-control"
                                                                        placeholder="Specify No. Unit/Pallet"
                                                    ...
                                                    <div class="row px-5">
                                                        <div class="col-lg-4">
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                                    ...
                                                                    id="construction_utility"
                                                                    name="Pickup_Service[]"
                                                                    value="Construction / Utility">
                                                                <label class="form-check-label"
                                                                    for="construction_utility">Construction /
                                                                    Utility</label>
                                                            </div>
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                            ...
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                                    class="form-check-input Pickup_Service"
                                                                    id="exhibition" name="Pickup_Service[]"
                                                                    value="Exhibition">
                                                                <label class="form-check-label"
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                                    class="form-check-input Pickup_Service"
                                                                    id="residential" name="Pickup_Service[]"
                                                                    value="Residential">
                                                                <label class="form-check-label"
                                                            ...
                                                            <div class="form-group form-check">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="sorting_segregation">Sorting /
                                                                    Segregation</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row px-5">
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                                    class="form-check-input Delivery_Service"
                                                                    id="del_container_station"
                                                                    name="Delivery_Service[]"
                                                                    value="Container Station">
                                                                <label class="form-check-label"
                                                                    for="del_container_station">Container
                                                                    Station</label>
                                                            </div>
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="form-group form-check">
                                                                <input type="checkbox"
                                                                    class="form-check-input Delivery_Service"
                                                                    id="inside_same_level_as"
                                                                    name="Delivery_Service[]"
                                                                    value="Inside - Same Level as Delivery Vehicle">
                                                                <label class="form-check-label"
                                                                    for="inside_same_level_as">Inside - Same Level as
                                                                    Delivery
                                                                    Vehicle</label>
                                                            </div>
                                                            <div class="form-group form-check">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 shadow-sm p-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="custom-file">
                                                                    <input type="file" class="custom-file-input"
                                                                        name="Vehcile_Images[]"
                                                                        id="image-upload-third" accept="image/*"
                                                                        multiple>
                                                                    <label class="custom-file-label">Choose
                                                                        file</label>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div id="image-preview-third" class="displayimages row">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="contractDropdown">Select Contract:</label>
                                                                <select class="form-control showmycontract123"
                                                                    onchange="updateTextareaAndLabelFreight()">
                                                                    @foreach ($MyContract as $key => $row)
                                                                        <option value="{{ $row->My_Contract }}"
                                                                            data-contract-name="{{ $row->contractName }}">
                                                                            Contract:{{ $key + 1 }} -
                                                            ...
                                                            <div class="form-group">
                                                                <label class="textareaLabel123">Contract</label>
                                                                <textarea class="showcontent123 form-control" cols="30" rows="15" name="Listing_Contract">
                                                                @if (count($MyContract) > 0)
                                                                {{ $MyContract[0]->My_Contract }}
                                                                @endif
                                                            </textarea>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // });
        $('#vehicle .Custom-Date').hide();
        $('#vehicle #custom_Check, #vehicle #private_Check').change(function() {
            if ($(this).is(':checked')) {
                $('#vehicle input[type="checkbox"]').not(this).prop('checked', false);
        ...
        $('#heavy .Dest_ZipCode_Heavy.typeahead').typeahead({
            source: function(query, process) {
                return $.get(path, {
                    query: query
                }, function(data) {
            ...
            updater: function(item) {
                ...
                $('.Dest_City_Heavy_d').val(city);
                $('.Dest_State_Heavy_d').val(state);
                $('.Dest_ZipCode2_Heavy_d').val(zipCode);
                return item;
            }
        });

        $('#heavy .Origin_ZipCode_Heavy.typeahead').typeahead({
            source: function(query, process) {
                return $.get(path, {
                    query: query
                }, function(data) {
            ...
            updater: function(item) {
                ...
                $('.Orig_City_Heavy').val(city);
                $('.Orig_State_Heavy').val(state);
                $('.Orig_ZipCode2_Heavy').val(zipCode);
        ...
        $('#dry .Dest_ZipCode_Dry.typeahead').typeahead({
            source: function(query, process) {
                return $.get(path, {
                    query: query
                }, function(data) {
            ...
            updater: function(item) {
                ...
                $('.Dest_City_Dry_d').val(city);
                $('.Dest_State_Dry_d').val(state);
                $('.Dest_ZipCode2_Dry_d').val(zipCode);
                return item;
            }
        });

        $('#dry .Origin_ZipCode_Dry.typeahead').typeahead({
            source: function(query, process) {
                return $.get(path, {
                    query: query
                }, function(data) {
            ...
            updater: function(item) {
                ...
                $('.Orig_City_Dry').val(city);
                $('.Orig_State_Dry').val(state);
                $('.Orig_ZipCode2_Dry').val(zipCode);
...
<script>
    ...
    function addPhoneNumber_Heavy(buttonId, inputId, containerId, messageId, phoneType) {
    var addButton = document.getElementById(buttonId);
    var phoneNumberInput = document.getElementById(inputId);
    addButton.addEventListener('click', function () {
        var phoneNumberValue = phoneNumberInput.value.trim();
    ...
    addPhoneNumber_Heavy('add-local-phone-number-heavy', 'local-phone-input-heavy', 'local-phone-numbers-toast-container-heavy', 'invalid-phone-message-heavy', 'Local_Phone');
    addPhoneNumber_Heavy('add-local-phone-number-heavy-d', 'local-phone-input-heavy-d', 'local-phone-numbers-toast-container-heavy-d', 'invalid-phone-message-heavy-d', 'Dest_Local_Phone');


    function addPhoneNumber_Freight(buttonId, inputId, containerId, messageId, phoneType) {
    var addButton = document.getElementById(buttonId);
    var phoneNumberInput = document.getElementById(inputId);
    addButton.addEventListener('click', function () {
        var phoneNumberValue = phoneNumberInput.value.trim();
    ...
    addPhoneNumber_Freight('add-local-phone-number-freight', 'local-phone-input-freight', 'local-phone-numbers-toast-container-freight', 'invalid-phone-message-freight', 'Local_Phone');
    addPhoneNumber_Freight('add-local-phone-number-freight-d', 'local-phone-input-freight-d', 'local-phone-numbers-toast-container-freight-d', 'invalid-phone-message-freight-d', 'Dest_Local_Phone');
