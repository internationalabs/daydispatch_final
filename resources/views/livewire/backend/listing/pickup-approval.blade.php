@section('PickUpApproval', 'mm-active')
<!-- Breadcrumb Area -->
@php
                        ...
                        @foreach ($Lisiting as $List)
                            <tr>
                                        ...
                                        @foreach ($List->all_listing->vehicles as $vehcile)
                                           <p class="ymm"> {{ $vehcile->Vehcile_Year }}
                                            ...
                                            @if (!empty($vehcile->Trailer_Type))
                                                <span>{{ $vehcile->Trailer_Type }}</span></span>
                                            @endif
                                        @endforeach
                                    @endif
                                    @if (count($List->all_listing->vehicles) > 1)
                                ...
                                <td>
                                    ...
                                    ({{ $List->all_listing->pickup_delivery_info->Delivery_Date_mode }})<br>
                                </td>
                                <td>
                                    ...
                                    <div class="dropdown show list-actions">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a href="{{ route('View.Agreement', ['List_ID' => $List->all_listing->id]) }}"
                                                target="_blank" class="dropdown-item" role="button">View Detail</a>
                                            <a data-toggle="modal" data-target="#CancelOrderModal"
                                                ...
                                                <input hidden type="text" class="CMP-ID"
                                                    value="{{ $List->all_listing->pickup_approve->pickup_approval_user->id }}">
                                            ...
                                            @if ($List->all_listing->user_id === $currentUser->id)
                                                ...
                                                <a href="{{ route('Order.Not.Pickup.Approval', ['List_ID' => $List->all_listing->id]) }}"
                                                    ...
                                                    Approve</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('Order.Pickup', ['List_ID' => $List->all_listing->id]) }}">Pick
                                                    Up</a>
                                               {{-- <a class="dropdown-item"
                            ...
                            <tr>
                                <td>
                                    <strong><a target="_blank"
                                            href="{{ route('View.Profile', $List->all_listing->pickup_approve->pickup_approval_user->id) }}">{{ $List->all_listing->pickup_approve->pickup_approval_user->Company_Name }}</a></strong><br>
                                    <strong><a
                                ...
                                <td>
                                    ...
                                    <br>
                                    {{-- <strong>Assigned to:
                                    </strong>{{ $List->all_listing->pickup_approve->pickup_approval_user->usr_type }}
                                    <br> --}}
                                    {{-- <strong><a
                                            href="{{ route('View.Profile', $List->all_listing->pickup_approve->pickup_approval_user->id) }}"
                                            target="_blank">View
                                            MC</a>&nbsp;&nbsp;<a
                                            href="{{ route('View.Profile', $List->all_listing->pickup_approve->pickup_approval_user->id) }}"
                                    ...
                                    <div class="dropdown show list-actions">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if ($List->all_listing->user_id === $currentUser->id)
                                                ...
                                                <a href="{{ route('Order.Not.Pickup.Approval', ['List_ID' => $List->all_listing->id]) }}"
                                                    target="_blank" class="dropdown-item" role="button">Not
                                                    Approve</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('Order.Pickup', ['List_ID' => $List->all_listing->id]) }}">Pick
                                                    Up</a>
                                            ...
                                            @if ($List->all_listing->user_id !== $currentUser->id)
                                                ...
                                                <a class="dropdown-item attach-bill" data-toggle="modal"
                                                    ...
                                                    <input hidden type="text" class="Listed-ID"
                                                        value="{{ $List->all_listing->id }}">Pickup</a>
                                            @endif
                                        </div>
                                    </div>
                                </td>
