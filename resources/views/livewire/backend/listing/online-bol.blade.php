    ...
    <form action="{{ route('store.online.bol') }}" id="myForm" method="post" enctype="multipart/form-data">
                ...
                <div class="card col-md-6">
                    <div class="card-body">
                        ...
                        @if ($auth_user->usr_type == 'Carrier')
                            <div class="mb-3">
                                <label for="inspectionImages" class="form-label fw-bold">Upload Inspection Images</label>
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-md-12">
                    <input type="checkbox" name="picked_up" class="" style="width: 15px;height: 15px">
                    Mark Pickup
                </div>
            </div>
        </div>
...
<script>
    ...
    images2.forEach((src, index) => {
        if (index < 3) {
            gallery.innerHTML += `<div class='col-6 mt-3'><img src='${src}' class='img-fluid2' onclick='openModal(${index})'></div>`;
        } else if (index === 3) {
            gallery.innerHTML += `<div class='col-6 mt-3 '>
