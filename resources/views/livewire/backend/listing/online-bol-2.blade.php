...
<body>
    <div class="container mt-4">
        ...
        @endif
        <form action="{{ route('store.online.bol') }}" id="myForm" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-8 d-flex gap-4">
                    <div class="card col-md-6 ">
                        <div class="card-body">
                            ...
                            <!-- Image Gallery -->
                            <div class="row mt-3" id="imageGallery">
                            </div>
                            ...
                            <table class="table mt-3">
                                ...
                                <tbody>
                                    ...
                                    @else
                                        ...
                                        <tr>
                                            <td>Navigation Disk</td>
                                            <td>N/A</td>
                                        </tr>
                                        <tr>
                                            <td>Plugin Charger Cable</td>
                                            <td>N/A</td>
                                        </tr>
                                        <tr>
                                            <td>HeadPhones</td>
            ...
            <div class="row">
                <div class="card w-100">
                    <div class="card-body">
                        <div class="row">
                            <!-- Left Column: Delivery Inspection -->
                            <div class="col-md-6">
                                <h3>Delivery Inspection</h3>
                                <p>This section shows inspection details once they are added.</p>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="deliver_no_odometer"
                                                    autocomplete="off" placeholder="No odometer">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Inspection Notes</strong></td>
                                            <td>
                                                <input type="text" class="form-control"
                                                    name="deliver_no_inspection_note" autocomplete="off"
                                                    placeholder="No inspection notes">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                    ...
                    <div class="card-body">
                        @if ($auth_user->usr_type != 'Carrier')
                            <div class="row  py-4 footer">
                                <div class="col-12 delivery-inspection">
                                ...
                                <div class="button-wrapper">
                                    <button type="button" class="btn btn-primary" onclick="enableDrawing()">Enable
                                        Highlighting
                                    </button>
                                    <button type="button" class="btn btn-secondary"
                                        onclick="disableDrawing()">Disable
                                        Highlighting
                                    </button>
                                    <button type="button" class="btn btn-danger" onclick="clearHighlights()">Clear
                                        Highlights
                                    </button>
                                    <button type="button" class="btn btn-info" data-toggle="modal"
                                        data-target="#imageModal">Upload Images
                                    </button>
                                    <button type="button" class="btn btn-secondary" onclick="prevImage()">Previous
                                        Image
                                    </button>
                                    <button type="button" class="btn btn-secondary" onclick="nextImage()">Next Image
                                    </button>
                                    <button type="button" class="btn btn-success" onclick="saveToTable()">Save to
                                        Table
                                    </button>
                                </div>

                                <div class="table-wrapper">
                                    <table id="highlightsTable" class="table table-bordered">
                                ...
                                <button type="submit" class="btn btn-primary">Submit PickUp Online Bol</button>
                            </div>
                        @endif
                    </div>
                </div>
    ...
    <script>
        ...
        const highlightsTable = document.getElementById("highlightsTable").querySelector("tbody");
        ...
        // html2canvas(imageWrapper, { useCORS: true }).then(canvas => {
        ...
        //         row.insertCell(1).textContent = `Image ${currentImageIndex + 1}`;
        //         row.insertCell(2).textContent = 'Highlights saved';
        //         row.insertCell(3).textContent = ''; // Placeholder
        //         row.insertCell(4).textContent = ''; // Placeholder
    ...
    <script>
        ...
        images2.forEach((src, index) => {
            if (index < 3) {
                gallery.innerHTML +=
                    `<div class='col-6 mt-3'><img src='${src}' class='img-fluid' onclick='openModal(${index})'></div>`;
            } else if (index === 3) {
                gallery.innerHTML += `<div class='col-6 mt-3 position-relative'>
                                        <img src='${src}' class='img-fluid' onclick='openModal(${index})'>
        ...
        function openModal(index) {
            currentIndex = index;
            modalImage.src = images2[currentIndex];
