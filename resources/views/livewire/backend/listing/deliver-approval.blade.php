@section('DeliverApproval', 'mm-active')
<!-- Breadcrumb Area -->
@php
...
<div class="breadcrumb-area">
    ...
    <ol class="breadcrumb">
        ...
        <li class="item">Deliver Approval</li>
    </ol>
    ...
    <div class="card-body">
        @if ($currentUser->usr_type === 'Carrier')
            ...
            <div class="table-responsive">
                <table class="display dataTable advance-69 datatable-range text-center w-100">
                    <thead>
                        <tr>
                            <th>Routes</th>
                            <th>Load Details</th>
                        ...
                        @foreach ($Lisiting as $List)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                    <strong>Job Price:</strong><span> ${{ $List->all_listing->paymentinfo->Price_Pay_Carrier }}
                                    </span>
                                    @endif
                                    <br>
                        ...
                        @foreach ($Lisiting as $List)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <br> --}}
                                    {{-- <strong><a
                                            href="{{ route('View.Profile', $List->all_listing->deliver_approve->deliver_approval_user->id) }}"
                                            target="_blank">View
                                            MC</a>&nbsp;&nbsp;<a
                                            href="{{ route('View.Profile', $List->all_listing->deliver_approve->deliver_approval_user->id) }}"
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @if ($List->all_listing->user_id === $currentUser->id)
                                                {{-- <a class="dropdown-item"
                                                    ...
                                                    Listing</a> --}}
                                                <a class="dropdown-item"
                                                    href="{{ route('Order.Deliverd', ['List_ID' => $List->all_listing->id]) }}">Deliveredsss</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('Order.Not.Deliverd', ['List_ID' => $List->all_listing->id]) }}">Not
                                                    Delivered</a>
                                                {{-- <a class="dropdown-item"
