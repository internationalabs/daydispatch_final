        ...
        <div class="row align-items-end">
            <div class="col-3">
                ...
                <select name="search_criteria" id="search_criteria" class="form-control">
                    <option value="1" {{ request()->input('search_criteria') == 1 ? 'selected' : '' }}>Order ID
                    </option>
                    <option value="2" {{ request()->input('search_criteria') == 2 ? 'selected' : '' }}>Pickup City
                    </option>
                    <option value="3" {{ request()->input('search_criteria') == 3 ? 'selected' : '' }}>Pickup State
                    </option>
                    <option value="4" {{ request()->input('search_criteria') == 4 ? 'selected' : '' }}>Delivery
                        City
                    </option>
                    <option value="5" {{ request()->input('search_criteria') == 5 ? 'selected' : '' }}>Delivery
                        State
                    </option>
                    <option value="6" {{ request()->input('search_criteria') == 6 ? 'selected' : '' }}>Company Name
                    </option>
                    <option value="7" {{ request()->input('search_criteria') == 7 ? 'selected' : '' }}>Vehicle
                    </option>
                </select>
            </div>
            <div class="col-3">
