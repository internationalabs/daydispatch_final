    ...
    <ul class="sidemenu-nav metisMenu h-100" id="sidemenu-nav" data-simplebar>
        ...
        <li class="sidebar nav-item">
            <a href="/" class="dropdown-btn nav-link collapsed" data-toggle="collapse"
                ...
                <span class="menu-title">Status Management &nbsp;<i class="fa-solid fa-caret-down fa-sm"></i></span>
            </a>
                ...
                <li class="sidebar nav-item">
                    ...
                    <div class="collapse dropdown-container" id="dropdown-container33">
                        <a href="{{ route('User.New.Quote') }}" class="nav-link @yield('New')">
                            <span class="icon"><i class='bx bx-home-circle'></i></span>
                            <span class="menu-title">New Quote</span>
                        </a>
                        @php
                            $count = isset($orderQuoteCount['statusCounts']['New Quote']) ? $orderQuoteCount['statusCounts']['New Quote'] : 0;
                        @endphp
                        <a href="{{ route('New.Order') }}" class="nav-link @yield('New')">
                            <span class="icon"><i class='bx bx-home-circle'></i></span>
                            <span class="menu-title">All New Orders</span>
                            <span class="badge">{{ $count }}</span>
                        </a>

                        <a href="{{ route('sidebar-options.create') }}" class="nav-link @yield('New')">
                            <span class="icon"><i class='bx bx-plus'></i></span>
                            <span class="menu-title">Create Own Field</span>
                        </a>
                        @php
                            $sidebarOptions = App\Models\SidebarOption::all();
                            $orders = App\Models\Quote\Order::all();
                        @endphp
                            ...
                            <ul class="sidebar-menu">
                                @foreach ($orders as $order)
                                    @if ($order->Listing_Status == $sidebarOption->name) -->
                                        ...
                                        <!-- <li class="nav-item">
                                            <a href="{{ route('Edit.Quote', $order->id) }}" class="nav-link">
                                                <span class="menu-title">{{ $order->Ref_ID }}</span>
                                            </a>
                                        </li> -->
