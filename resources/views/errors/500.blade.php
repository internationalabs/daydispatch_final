...
<head>
    ...
    <meta charset="utf-8" />
    <title>Day Dispatch | 500 Server Error</title>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 text-center">
                    <div class="error-500 position-relative">
                        <img src="{{ asset('errors/error500.png') }}" alt="" class="img-fluid error-500-img error-img" />
                    ...
                    <div>
                        ...
                        <a href="{{ redirect()->back() }}" class="btn btn-success"><i class="mdi mdi-home me-1"></i>Back to home</a>
                    </div>
                </div><!-- end col-->
            </div>
            <!-- end row -->
