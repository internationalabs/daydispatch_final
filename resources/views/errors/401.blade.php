...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Day Dispatch | 404 Un-Authorized</title>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-4 text-center">
                    <div class="error-500 position-relative">
                        <img src="{{ asset('errors/401error.png') }}" alt="" class="img-fluid error-500-img error-img"/>
                        <h1 class="title text-muted">401</h1>
                    </div>
                    <div>
                        <h4>The Page isn't Working!</h4>
                        <p class="text-muted w-75 mx-auto">The HyperText Transfer Protocol (HTTP) 401 Unauthorized
                            response status code indicates that the client request has not been completed because it
                            lacks valid authentication credentials for the requested resource.</p>
