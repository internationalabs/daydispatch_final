...
<html>
<head>
    <title>DayDispatch | Ref ID => {{ $order_ID }}</title>
</head>
<body>
    ...
    <tr>
        <td class="o_bg-light o_px-xs o_pt-lg o_xs-pt-xs" align="center" data-bgcolor="Bg Light"
            ...
            <table class="o_block-lg ui-resizable" width="100%" cellspacing="0" cellpadding="0" border="0"
                ...
                <tbody>
                <tr>
                    <td class="o_re o_bg-white o_px o_pb-md o_br-t" align="center" data-bgcolor="Bg White"
                        ...
                        <div class="o_col o_col-2"
                            ...
                            <div class="o_px-xs o_sans o_text o_left o_xs-center" data-size="Text Default" data-min="12"
                                ...
                                <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-primary" target="_blank"
                                ...
                                <table class="o_right o_xs-center" cellspacing="0" cellpadding="0" border="0"
                                    ...
                                    <tr>
                                        <td class="o_btn-xs o_bg-primary o_br o_heading o_text-xs" align="center"
                                            ...
                                            <a class="o_text-white" target="_blank" href="{{ route('Auth.Forms') }}"
                                               data-color="White"
...
<table data-module="hero-white-icon-lines0"
       data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/qKZph9WIdg2ti3Lu8Ejc4VTH/account_invitation/thumbnails/hero-white-icon-lines.png"
            ...
            <table class="o_block-lg ui-resizable" width="100%" cellspacing="0" cellpadding="0" border="0"
                ...
                <tr>
                    <td class="o_bg-white o_px-md o_py-xl o_xs-py-md" align="center" data-bgcolor="Bg White"
                        ...
                        data-quillbot-parent="zj3KTqHDr6jpRMNCB9_wp">
                        <!--[if mso]>
                        <table width="584" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            <tbody>
                            <tr>
                                <td align="center"><![endif]-->
                        <div class="o_col-6s o_center o_sans o_text-md o_text-light selected-element" data-color="Light"
                             ...
                             data-quillbot-element="zj3KTqHDr6jpRMNCB9_wp">
                            <table class="o_center" role="presentation" cellspacing="0" cellpadding="0" border="0"
                                ...
                                <tr>
                                    ...
                                    <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py" align="center"
                                        ...
                                        <img
                                            src="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/qKZph9WIdg2ti3Lu8Ejc4VTH/account_invitation/images/record_voice_over-48-primary.png"
                            ...
                            <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2"
                                ...
                                You've Been Invited By {{ $mailData['Broker_CMP'] }}</h2>
                            <p style="margin-top: 0px;margin-bottom: 0px;">Welcome To Day Dispatch We Offer you to join
                                our team, to connect with 10000+ Customers on daily basis.</p>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    </td>
                </tr>
...
<table data-module="content0"
       data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/qKZph9WIdg2ti3Lu8Ejc4VTH/account_invitation/thumbnails/content.png"
       width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    <tbody>
    <tr>
        <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light"
                ...
                <tr>
                    <td class="o_bg-white o_px-md o_py" align="center" data-bgcolor="Bg White"
                        ...
                        <div class="o_col-6s o_sans o_text o_text-secondary o_center" data-color="Secondary"
                            ...
                            <p style="margin-top: 0px;margin-bottom: 0px;">{{ $mailData['body'] }}</p>
                        </div>
                        <!--[if mso]></td></tr></table><![endif]-->
                    </td>
                </tr>
...
<table data-module="button-success0"
       data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/qKZph9WIdg2ti3Lu8Ejc4VTH/account_invitation/thumbnails/button-success.png"
       width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    <tbody>
    <tr>
        <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light"
                        ...
                        <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            ...
                            <tr>
                                <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                                    ...
                                    <a class="o_text-white" target="_blank" href="{{ route('Auth.Forms') }}"
                                       data-color="White"
                                       style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Proceed</a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<table data-module="spacer-lg0"
       data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/qKZph9WIdg2ti3Lu8Ejc4VTH/account_invitation/thumbnails/spacer-lg.png"
       width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    <tbody>
    <tr>
        <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light"
...
<table data-module="footer" data-visible="false"
       data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/qKZph9WIdg2ti3Lu8Ejc4VTH/account_invitation/thumbnails/footer.png"
       width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    <tbody>
    <tr>
