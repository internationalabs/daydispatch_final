...
<html>
<head>
    <title>Online BOL Submission</title>
</head>
<body>
    <h1>Online BOL Submission Details</h1>
    <p><strong>Order ID:</strong> {{ $data['order_id'] }}</p>
    <p><strong>User ID:</strong> {{ $data['user_id'] }}</p>
    <p><strong>Key:</strong> {{ $data['key'] }}</p>
    <p><strong>No Odometer:</strong> {{ $data['no_odometer'] }}</p>
    <p><strong>No Inspection Note:</strong> {{ $data['no_inspection_note'] }}</p>
