...
<html>
<head>
    <title>DayDispatch | Order ID => {{ $mailData['Ref_ID'] }}</title>
</head>
<body>
                ...
                <tr>
                    <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light" align="center"
                        ...
                        <h2 class="o_heading o_text-dark o_mb-xxs" data-color="Dark" data-size="Heading 2" data-min="20"
                            ...
                            Load Alert</h2>
                        <p style="margin-top: 0px;margin-bottom: 0px;"><strong>{{ $mailData['Assign_User_Name'] }}</strong>
                            Has Posted a Load 
                            {{-- for {{ $mailData['vehicle'] }} --}}
                            on <strong>{{ $mailData['Created_At'] }}</strong></p>
                    </td>
                </tr>
                </tbody>
            </table>
                ...
                <tr>
                    <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                        ...
                        <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                            ...
                            <tr>
                                <td width="300" class="o_btn o_bg-success o_br o_heading o_text" align="center"
                                    ...
                                    <a class="o_text-white" href="{{ route('Auth.Forms') }}" target="_blank"
                                       data-color="White"
                                       style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;"><strong>{{ $mailData['Ref_ID'] }}</strong></a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <h4 class="o_heading o_text-dark o_mb-xxs selected-element" data-color="Dark"
                            ...
                            data-quillbot-element="hTUW1QMrmqoOny8XO5GXh">Listed Price ${{ $mailData['Listed_Price']
                            }}</h4>
                        <p class="o_text-xs o_text-light o_mb-md" data-color="Light" data-size="Text XS" data-min="10"
                           ...
                           style="font-size: 14px;line-height: 21px;color: #82899a;margin-top: 0px;margin-bottom: 0px;">
                            Payment Method: {{ $mailData['Payment_Method'] }}</p>
                    </td>
                </tr>
                </tbody>
            </table>
...
<table data-module="order-details0"
       data-thumb="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/13/HQ3kphtSsgIn8Olvz9buGo5R/order_confirmation/thumbnails/order-details.png"
       width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
    <tbody>
    <tr>
        <td class="o_bg-light o_px-xs" align="center" data-bgcolor="Bg Light"
            ...
            <table class="o_block ui-resizable" width="100%" cellspacing="0" cellpadding="0" border="0"
                ...
                <tbody>
                <tr>
                    <td class="o_re o_bg-white o_px o_pb-md" align="center" data-bgcolor="Bg White"
                                ...
                                <table width="100%" role="presentation" cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tr>
                                        <td class="o_bg-ultra_light o_br o_px o_py o_sans o_text-xs o_text-secondary"
                                            align="left" data-bgcolor="Bg Ultra Light" data-color="Secondary"
                                            ...
                                            <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;"><strong>Order
                                                    Information</strong></p>
                                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 0px;">
                                                {{-- <b>Vehicle: </b><br>
                                                $mailData['vehicle'] --}}<br>
                                                <b>Posted By: </b><br>
                                                {{ $mailData['Assign_User_Name'] }}<br>
                                            </p>
                                        </td>
                                    </tr>
                                    </tbody>
                                    ...
                                    <tr>
                                        <td class="o_bg-ultra_light o_br o_px o_py o_sans o_text-xs o_text-secondary"
                                            ...
                                            <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;"><strong>Shipping
                                                    Information</strong></p>
                                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 0px;"><strong>PickUp
                                                    Address:</strong><br>
                                                {{ $mailData['Origin_ZipCode'] }}
                                                {{-- <br>
                                                {{ $mailData['Origin_Address'] }} --}}
                                            </p>
                                            <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 0px;"><strong>Delivery
                                                    Address:</strong><br>
                                                {{ $mailData['Dest_ZipCode'] }}
                                                {{-- <br>
                                                {{ $mailData['Destination_Address'] }} --}}
                                            </p>
                                        </td>
                                    </tr>
                                    </tbody>
