...
class LogisticCarrier extends Model
{
    use HasFactory;
    protected $table = "carrier_by_state";
    ...
    {
        $history = LogisticCarrierCallHistory::where('permission', $id)
            ->get();
    ...
    {
        return $this->hasMany(LogisticCarrierCallHistory::class, 'permission')->latest('id');
    }
    
    public function callCount()
    {
        return $this->hasMany(LogisticCarrierCallCount::class, 'company_id');
    }
