...
class ReplicateListing extends Component
{
    public function render(Request $request)
    {
        ...
        return view('livewire.backend.listing.replicate-listing', compact('Listed_ID', 'Lisiting', 'Pickup_Services', 'Delivery_Services', 'currentRouteMatchesPattern', 'MyContract'))->layout('layouts.authorized');
    }
}
